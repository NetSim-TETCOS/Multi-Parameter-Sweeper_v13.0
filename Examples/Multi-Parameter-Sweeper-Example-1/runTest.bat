SET NETSIM_PATH="C:\\Users\\Ranveer\\Documents\\NetSim_13.0.22_64_std_default\\bin\\bin_x64"
SET NETSIM_AUTO=1
...
FOR /L %%i IN (250,50,400) DO (
	...
	"%NETSIM_PATH%\NetSimcore" -apppath "%NETSIM_PATH%" -iopath "IOPath" -license 5053@192.168.0.9
